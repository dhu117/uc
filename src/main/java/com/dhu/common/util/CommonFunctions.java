...
public class CommonFunctions {
	...
	public static int getEvenOrOddType(Integer number, int pos) {
		int num = number.toString().charAt(pos) - '0';
		if (num % 2 == 0) {
	...
	public static int getBigOrSmallType(Integer number, int pos) {
		int num = number.toString().charAt(pos) - '0';
		if (num > 4) {
